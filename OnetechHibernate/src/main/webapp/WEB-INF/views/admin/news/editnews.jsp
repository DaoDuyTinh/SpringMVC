...
<!-- Begin Page Content -->
		...
		<div class="panel panel-primary">
			...
			<form:form action="${pageContext.request.contextPath}/quan-ly/news/edit" modelAttribute="news" method="POST">  
				...
				<div class="form-group">
				  ...
				  <form:textarea required="true" type="textarea" class="form-control" path="description" id="editor1" height="1000"/>
				</div>
				<div class="form-group">
				  <label for="pwd">Hình ảnh:</label>
				  <form:input required="true" type="text" class="form-control" path="image" id="xFilePath"/>
				  <input type="button" value="Browse Server" onclick="BrowseServer();" />
				</div>
				<div class="form-group">
				  <label for="pwd">Trạng thái</label>
				  <form:checkbox class="form-control" path="status" width="10%" margin-left="0"/>
				</div>
