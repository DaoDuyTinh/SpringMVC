                                ...
                                <table class="table table-bordered" id="dataTable" width="70%" cellspacing="0">
                                    ...
                                    <c:forEach var="category" items= "${allcate}">
                                        <tr>
                                            ...
                                            <td><img src="${pageContext.request.contextPath}/resources/images/${category.getImage() }" witdth ="70" height="70" alt="${product.getImage() }"></td>
                                            <td>${category.getDescription() }</td>
                                            <td><a href=""><img src="${pageContext.request.contextPath}/resources/imgad/update.png" witdth ="50" height="50" alt="Cập nhật"></a></td>
                                            <td><a href=""><img src="${pageContext.request.contextPath}/resources/imgad/delete.png" witdth ="50" height="50" alt="Xóa"></a></td>
                                        </tr>
                                     </c:forEach>                                      
                                     </tbody>
                                </table>
